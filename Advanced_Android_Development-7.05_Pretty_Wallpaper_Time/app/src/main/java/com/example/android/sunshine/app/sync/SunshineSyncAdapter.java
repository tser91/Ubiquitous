...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
        ...
        googleApiClient = new GoogleApiClient.Builder(getContext())
                .addConnectionCallbacks(new GoogleApiClient.ConnectionCallbacks() {
                    ...
                    public void onConnected(Bundle bundle) {
                        System.out.println("PASA POR ACA 7");
                    }
                ...
                .addOnConnectionFailedListener(new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(ConnectionResult connectionResult) {
                        System.out.println("PASA POR ACA 99");
                    }
                })
                .addApi(Wearable.API)
                .build();
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            // Reference: http://stackoverflow.com/questions/24595679/how-to-use-dataitem-of-android-wear
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(getContext().getResources(),
                    Utility.getArtResourceForWeatherCondition(weatherToday));
